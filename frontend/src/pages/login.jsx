    ...
    <section className="login-layout" aria-labelledby="login-heading">
      ...
      <section className="login-card" aria-label="Sign in to Athletica">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="input-field"><Icon name="user" size={18} /><input id="username" type="text" autoComplete="username" placeholder="you@example.com" required /></div>
          ...
          <div className="input-field"><Icon name="lock" size={18} /><input id="password" type={showPassword ? 'text' : 'password'} autoComplete="current-password" placeholder="Enter your password" required /><button className="password-toggle" type="button" aria-label={showPassword ? 'Hide password' : 'Show password'} onClick={() => setShowPassword(!showPassword)}><Icon name="eye" size={18} /></button></div>
          ...
          <button className="sign-in-button" type="submit">Sign In <Icon name="arrow" size={18} /></button>
        </form>
